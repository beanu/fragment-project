...
import com.beanu.project.fragments.indexA.IndexAFragment;
import com.beanu.project.fragments.indexB.IndexBFragment;
...
public class MainActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTabManager.addTab(mTabHost.newTabSpec("One").setIndicator("View Pager"),
				IndexAFragment.class, null);
		mTabManager.addTab(mTabHost.newTabSpec("Two").setIndicator("Single Fragment"),
				IndexBFragment.class, null);
	}

	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add("Save").setIcon(R.drawable.ic_compose_inverse)
